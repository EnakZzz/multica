...
// (@-mention agent or a prior assignee) re-fires the new
...
func TestRerunIssueTargetsSourceTaskAgent(t *testing.T) {
	...
	// in as a "row whose agent is no longer the issue assignee" — e.g. an
	// @-mentioned agent. The issue's assignee is still
