		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/projects", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Post("/knowledge/embeddings/backfill", h.BackfillProjectKnowledgeEmbeddings)
					...
					r.Delete("/visual-board", h.ClearProjectVisualBoard)
					...
					r.Post("/visual-nodes", h.CreateProjectVisualNode)
					r.Delete("/visual-nodes/{nodeId}", h.DeleteProjectVisualNode)
					r.Post("/visual-nodes/{nodeId}/generate", h.GenerateProjectVisualNodeImage)
					r.Get("/visual-nodes/{nodeId}/generations", h.ListProjectVisualNodeGenerations)
					r.Post("/visual-nodes/{nodeId}/generations/{generationId}/restore", h.RestoreProjectVisualNodeGeneration)
			...
			r.Route("/api/pipelines", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Post("/duplicate", h.DuplicatePipeline)
