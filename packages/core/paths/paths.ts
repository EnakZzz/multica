...
function workspaceScoped(slug: string) {
  ...
  return {
    ...
    plans: () => `${ws}/plans`,
    planDetail: (id: string) => `${ws}/plans/${encode(id)}`,
    pipelines: () => `${ws}/workflows`,
    pipelineDetail: (id: string) => `${ws}/workflows/${encode(id)}`,
    legacyPipelines: () => `${ws}/pipelines`,
    legacyPipelineDetail: (id: string) => `${ws}/pipelines/${encode(id)}`,
